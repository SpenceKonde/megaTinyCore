...
#define BUTTON_PIN   PIN_PA2    // Digital IO pin connected to the button.
// This should be pulled up so the switch should
// pull the pin to ground momentarily.  On a high -> low
// transition the button press logic will execute.

#define PIXEL_PIN    PIN_PA1    // Digital IO pin connected to the NeoPixels, chosen because all parts have it
