...
#include <tinyNeoPixel_StaticPORTA.h>
...
#define PIXEL_PIN    0    // Digital IO pin connected to the NeoPixels - this is always on port A on megaTinyCore parts, so this is the appropriate library to use.
