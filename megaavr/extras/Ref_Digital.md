...
Not classic tinies, not classic atmegas. They met symmetric specs, the low side driver always met it with far more room to spare than the high side one. That said, the difference in drive strength is on the magntude of a power of two. (compare to some older devices that would have a 0.4mA high-side drive and 20mA low side drive (at least they could drive high, which wasn't universal then))
