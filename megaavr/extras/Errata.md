...
This list does not cover several newly discovered erratas. or the 2-series (at least so far, hte list of 2=series errata is far shorter, which is at least a step in the right direction)
