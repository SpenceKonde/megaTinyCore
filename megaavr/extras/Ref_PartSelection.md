...
The problem with the 0-series is that they have features like a bare-bones budget part, but the low price point of the 1-series doesn't leave much room for such a part on the market, and the savings are minuscule, while they lose large amounts of functionality.
