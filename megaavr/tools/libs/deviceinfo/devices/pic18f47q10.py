"""
Required device info for the PIC18F47Q10 devices
"""
...
DEVICE_INFO = {
    ...
    'flash_size_bytes': 128*1024,  # 64KW
    'flash_page_size_words': 128, # No page buffer so this is for sector erase
