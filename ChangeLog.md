...
* Errata section udatend with recently discovered bugs. Chenged my asssmenty of the severity of a number of the bugs (for example, the RTC bugs are much higher now, because I have watched someone trying to figurte out howe the herll they work; it wasn't pretty)
