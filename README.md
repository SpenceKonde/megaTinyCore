...
**Testing has revealed that timekeeping (millis, delay, etc) is severely broken, especially on parts other than 1616 and 3216 (suspect it's also less-severely-wrong on 1614, 3217 and 1617). We are aware of the issue and working on it. This will be fixed in 1.0.1**
