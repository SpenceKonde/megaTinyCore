...
Do you think there will be a 3 series? I do not. DD and the almost ready EA's are  taking up strategic position around the armies of tinyAVR. into the heart ogf tiny AVR territory as we speak.
That's not necessarily a bd thing. But let's not kid ourselves. Them made some freakin stupid decisions on the tinies. (A6 A7 B7 Why not have all the ports go i nthr same diretion likie they did on everything else,. sending tinyAVR for a long walk of a short pier would solve that.

I predict, that in 2-4 years tme, there's an AVR DA, DB, DD. DU (the USB one), EA, EB (I'm hoping for 32=-64 pin, up to 128k flash, the good ADC, and there's a EC/ED with flash down to at least 8k, pincounts down to 14 (8 maybe? Naw, I tink 8 pin AVRs are over), and 20-pin versions in QFN20, the tiny one like the txxy6's use. *But this only pure speculation.*
