...
Having determined that Arduino doesn't care about this issue (it's as if they have no concern for third party hardware - almost like they were selling hardware themselves or something), the most recent versions have explicitly worked around this.
